...
def predict_from_interface(
    ...
    def add_all_missing_boolean_features(character_data):
        """Add all missing boolean features expected by the model with default False values."""
        ...
        all_boolean_features = [
            ...
            # Store mount features (132 total)
            ...
            # Store outfit features (95 total)
        ...
        # Add all boolean features with False as default
        for feature_name in all_boolean_features:
            character_data[feature_name] = False
            
        return character_data
    
    # Apply all the missing boolean features
    character_data = add_all_missing_boolean_features(character_data)
