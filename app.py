#!/usr/bin/env python3
"""
Tibia Character Automated Quotation System (TCAQS) - Gradio Spaces Compatible Version
...
# Configuration for Gradio Spaces compatibility
...
# =============================================================================
# PART 2: SERVER LOADING AND CONFIGURATION
# =============================================================================
...
def get_all_servers():
    """Get all server names from servers.json (no database dependency)."""
    try:
        servers_path = os.path.join(BASE_DIR, 'data', 'servers.json')
        with open(servers_path, 'r') as f:
            servers_data = json.load(f)
        servers = list(servers_data.keys())
        servers.sort()
        return servers
    except Exception as e:
        print(f"❌ Error retrieving server names: {e}")
        # Fallback to a predefined list based on servers.json
        return [
            "Adra", "Aethera", "Alumbra", "Ambra", "Antica", "Ardera", "Assombra", "Astera", "Axera", 
            "Bastia", "Batabra", "Belluma", "Belobra", "Bombra", "Bona", "Bravoria", "Cadebra", 
            "Calmera", "Cantabra", "Carnera", "Castela", "Celebra", "Celesta", "Collabra", "Concorda", 
            "Cosera", "Damora", "Descubra", "Dia", "Dibra", "Divina", "Duna", "Emera", "Endebra", 
            "Endera", "Endura", "Epoca", "Esmera", "Estela", "Etebra", "Faluna", "Famosa", "Fera", 
            "Ferobra", "Fervora", "Fibera", "Firmera", "Flamera", "Funera", "Furia", "Garnera", 
            "Gentebra", "Gladera", "Gladibra", "Gravitera", "Guerribra", "Harmonia", "Havera", 
            "Helera", "Honbra", "Ignitera", "Illusera", "Impera", "Impulsa", "Inabra", "Issobra", 
            "Jacabra", "Jadebra", "Jaguna", "Javibra", "Jonera", "Juva", "Kalibra", "Kalimera", 
            "Kardera", "Karmeya", "Karna", "Kendria", "Kenora", "Libertabra", "Lobera", "Luminera", 
            "Lutabra", "Luzibra", "Macabra", "Malivora", "Marbera", "Marcia", "Menera", "Mercera", 
            "Mitigera", "Monza", "Mudabra", "Mykera", "Nadora", "Nefera", "Nevia", "Nexa", "Noctalia", 
            "Noctera", "Nossobra", "Obscubra", "Oceanis", "Ocebra", "Olera", "Olima", "Ombra", 
            "Optera", "Ourobra", "Ousabra", "Pacembra", "Pacera", "Peloria", "Premia", "Pulsera", 
            "Pyra", "Quebra", "Quelibra", "Quidera", "Quintera", "Ragna", "Rasteibra", "Refugia", 
            "Reinobra", "Relania", "Relembra", "Retalia", "Runera", "Seanera", "Secura", "Serdebra", 
            "Serenebra", "Solidera", "Sonira", "Stralis", "Suna", "Syrena", "Talera", "Tembra", 
            "Temera", "Thyria", "Tornabra", "Torpera", "Tortura", "Trona", "Ulera", "Unebra", 
            "Unica", "Unisera", "Ustebra", "Utobra", "Vandera", "Velocera", "Velocibra", "Velocita", 
            "Venebra", "Versa", "Victoris", "Visabra", "Vita", "Vitera", "Vunira", "Wadira", 
            "Wildera", "Wintera", "Wizera", "Xandebra", "Xybra", "Xyla", "Xylona", "Yara", 
            "Yonabra", "Yovera", "Ysolera", "Yubra", "Zenobra", "Zephyra", "Zuna", "Zunera"
        ]

# Load server information
print("🔄 Loading server information...")
SERVER_INFO = load_server_info()
ACTUAL_SERVERS = get_all_servers()
print(f"✅ Loaded {len(ACTUAL_SERVERS)} servers from servers.json")
print(f"✅ Server info loaded for {len(SERVER_INFO)} servers")
...
def add_all_missing_boolean_features(character_data, selected_imbuements, selected_charms_features, 
    ...
    # Add store mounts (comprehensive list)
    all_store_mounts = [
    ...
    # Add store outfits (comprehensive list)
    all_store_outfits = [
...
def create_gradio_interface():
    """Create the comprehensive Gradio interface with all tabs."""
...
def launch_app():
    ...
    print("🚀 Launching Tibia Character Automated Quotation System...")
    ...
    # Launch with Gradio Spaces compatible settings
    iface.launch(
...
# For script execution (not just import)
